              ...
              Column(
                children: [
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: TextField( // ENTER TASK MAIN FIELD
                            ...
                            controller:
                            TextEditingController()..text = _taskTitle!,
                  ...
                  Visibility(
                    ...
                    child: Padding( // ENTER DESCRIPTION
                      padding: EdgeInsets.only(
                        bottom: 12.0,
                      ),
                      child: TextField(
                        ...
                        _taskDescription == null ? "" : _taskDescription.toString(),
                        decoration: InputDecoration(
                              ...
                              return GestureDetector(
                                onTap: () async {
                                  if (snapshot.data?[index].isDone == 0) {
                                    await _dbHelper.updateIsDone(snapshot.data?[index].id, 1);
                                  } else {
                                    await _dbHelper.updateIsDone(snapshot.data?[index].id, 0);
                                  }
                                  setState(() {});
                                },
                                child: CheckListWidget(
                                  text: snapshot.data?[index].title,
                                  isDone: snapshot.data?[index].isDone == 0 ? false
                                  : true,
                                )
                              );
                            },
